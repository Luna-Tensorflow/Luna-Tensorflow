...
void add_attr_type_list(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, TF_DataType* types, uint32_t num_types) {
    LOG(attr_list, name, types, num_types);
...
void add_attr_shape(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, int64_t* dims, uint32_t num_dims) {
...
void add_attr_shape_list(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, int64_t** dims, uint32_t* dims_sizes, uint32_t num_dims) {
    LOG(attr_list, name, dims, dims_sizes, num_dims);
...
void add_attr_tensor_list(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, Tensor** tensors, uint32_t num_tensors) {
    LOG(attr_list, name, tensors, num_tensors);
...
void add_attr_int_list(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, int64_t* values, uint32_t num_values) {
    LOG(attr_list, name, values, num_values);
...
void add_attr_float_list(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, float* values, uint32_t num_values) {
    LOG(attr_list, name, values, num_values);
...
void add_attr_bool_list(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, unsigned char* values, uint32_t num_values) {
    LOG(attr_list, name, values, num_values);
...
void add_attr_string_list(std::vector<std::shared_ptr<Attr>>* attr_list, char* name, char** values, uint32_t num_values) {
    LOG(attr_list, name, values, num_values);
    attr_list->push_back(std::make_shared<AttrStringList>(std::string(name), std::vector<std::string>(values, values + num_values)));
}

void add_attr_func_name(std::vector<std::shared_ptr<Attr>> *attr_list, char *name, char *func_name) {
    LOG(attr_list, name, func_name);
